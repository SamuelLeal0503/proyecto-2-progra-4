...
<%@page import="proyecto.presentacion.registro.paciente.Model"%>
...
<head>
    ...
    <meta name="description" content="Registro Paciente">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-form">
                    ...
                    <form name="form" id="registro" action="/proyecto-1-progra-4/presentacion/registro/paciente/registro" method="post" onsubmit="event.preventDefault(); return checkPass();">
                        ...
                        <div class="social-button">
                            <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30 btn-flat btn-addon mt-2">Registrarse (Paciente) </button>
                        </div>
