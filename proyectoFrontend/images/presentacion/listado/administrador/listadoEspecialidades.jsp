<%-- 
    Document   : listadoEspecialidades
    Created on : Apr 14, 2022, 5:37:48 PM
...
<html>
    <head>
        ...
        <meta name="description" content="Listado Especialidades">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Listado Especialidades</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Lista de Especialidades</strong>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-3">
                      <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="/proyecto-1-progra-4/presentacion/listado/administrador/agregarEspecialidad" method="post" class="">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" name="nombreespecialidad" placeholder="Especialidad" class="form-control" required>
