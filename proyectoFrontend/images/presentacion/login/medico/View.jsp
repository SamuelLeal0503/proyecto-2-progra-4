...
<%@page import="proyecto.presentacion.login.medico.Model"%>
...
<head>
    ...
    <meta name="description" content="Login Medico">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-form">
                    <form name="form" action="/proyecto-1-progra-4/presentacion/login/medico/login" method="post">
                        ...
                        <div class="social-button">
                                <button type="submit" class="btn social twitter btn-flat btn-addon mt-3">Iniciar sesion (Medico) </button>
                        </div>
                        <div class="register-link m-t-15 text-center">
                            <p>No tienes una cuenta? <a href="/proyecto-1-progra-4/presentacion/registro/medico/show"> Registrarse</a></p>
                        </div>
                    </form>
                </div>
            </div>
